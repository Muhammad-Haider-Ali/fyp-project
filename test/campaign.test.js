...
beforeEach(async () => {
  ...
  // create instance of deployed campaign
...
describe("Campaign", () => {
  ...
  it("allow user to contribute in campaign and marks them as approvers", async () => {
  ...
  it("only mananger can make a campaign request", async () => {
